...
const { loading, patients, loadPatients, removePatient } = usePatients();
...
<template>
    <div class="row">
        ...
        >
            <template v-slot:top>
                <span class="text-h6">
                    {{ $t('patient.label.patients') }}
                </span>
                <q-space />
                <q-btn
                    v-if="$q.platform.is.desktop"
                    :label="$t('patient.label.createPatient')"
                    color="primary"
                    icon="mdi-plus"
                    dense
                    @click="
            ...
            <template v-slot:body-cell-actions="props">
                <q-td :props="props" class="q-gutter-x-sm">
                    ...
                    <q-btn
                        ...
                        dense
                        size="sm"
                        @click="removePatient(props.row.id)"
                    >
